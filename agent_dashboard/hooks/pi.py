...
class PiJsonHook:
    ...
    def __init__(self, *, host_id: str, working_dir: str | Path, location: dict[str, Any]):
    ...
    def normalize(self, record: str | dict[str, Any]) -> AgentEvent | None:
        ...
        return AgentEvent(event_id=uuid4(), agent_id=self.session_id, session_id=self.session_id,
